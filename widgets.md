...
Container widget, here to see flutter [Container widget](https://api.flutter.dev/flutter/widgets/Container-class.html) definition.
...
Text widget, here to see flutter [Text widget](https://api.flutter.dev/flutter/widgets/Text-class.html) definition. Supported json properties:
...
TextSpan, here to see flutter [TextSpan](https://api.flutter.dev/flutter/painting/TextSpan-class.html) definition. Supported json properties:
...
TextStyle, here to see flutter [TextStyle](https://api.flutter.dev/flutter/painting/TextStyle-class.html) definition. Supported json properties:
...
RaisedButton widget, here to see flutter [RaisedButton widget](https://api.flutter.dev/flutter/widgets/Text-class.html) definition. Supported json properties:
...
Row widget, here to see flutter [Row widget](https://api.flutter.dev/flutter/widgets/Row-class.html) definition. Supported json properties:
...
Column widget, here to see flutter [Column widget](https://api.flutter.dev/flutter/widgets/Column-class.html) definition. Supported json properties:
...
AssetImage widget, here to see flutter [Asset Image widget](https://api.flutter.dev/flutter/widgets/Image-class.html) definition. Supported json properties:
...
NetworkImage widget, here to see flutter [Network Image widget](https://api.flutter.dev/flutter/widgets/Image-class.html) definition. Supported json properties:
...
FileImage widget, here to see flutter [File Image widget](https://api.flutter.dev/flutter/widgets/Image-class.html) definition. Supported json properties:
...
Placeholder widget, here to see flutter [Placeholder widget](https://api.flutter.dev/flutter/widgets/Placeholder-class.html) definition. Supported json properties:
...
GridView widget, here to see flutter [GridView widget](https://api.flutter.dev/flutter/widgets/GridView-class.html) definition. Supported json properties:
...
ListView widget, here to see flutter [ListView widget](https://api.flutter.dev/flutter/widgets/ListView-class.html) definition. Supported json properties:
...
PageView widget, here to see flutter [PageView widget](https://api.flutter.dev/flutter/widgets/PageView-class.html) definition. Supported json properties:
...
Expanded widget, here to see flutter [Expanded widget](https://api.flutter.dev/flutter/widgets/Expanded-class.html) definition. Supported json properties:
...
Padding widget, here to see flutter [Padding widget](https://api.flutter.dev/flutter/widgets/Padding-class.html) definition. Supported json properties:
...
Center widget, here to see flutter [Center widget](https://api.flutter.dev/flutter/widgets/Center-class.html) definition. Supported json properties:
...
Align widget, here to see flutter [Align widget](https://api.flutter.dev/flutter/widgets/Align-class.html) definition. Supported json properties:
...
AspectRatio widget, here to see flutter [AspectRatio widget](https://api.flutter.dev/flutter/widgets/AspectRatio-class.html) definition. Supported json properties:
...
FittedBox widget, here to see flutter [FittedBox widget](https://api.flutter.dev/flutter/widgets/FittedBox-class.html) definition. Supported json properties:
...
Baseline widget, here to see flutter [Baseline widget](https://api.flutter.dev/flutter/widgets/Baseline-class.html) definition. Supported json properties:
...
Stack widget, here to see flutter [Stack widget](https://api.flutter.dev/flutter/widgets/Stack-class.html) definition. Supported json properties:
...
Positioned widget, here to see flutter [Positioned widget](https://api.flutter.dev/flutter/widgets/Positioned-class.html) definition. Supported json properties:
...
IndexedStack widget, here to see flutter [IndexedStack widget](https://api.flutter.dev/flutter/widgets/IndexedStack-class.html) definition. Supported json properties:
...
ExpandedSizedBox widget, here to see flutter [ExpandedSizedBox widget](https://api.flutter.dev/flutter/widgets/SizedBox-class.html) definition. It's a shortcut of **SizedBox.expand**. Supported json properties:
...
SizedBox widget, here to see flutter [SizedBox widget](https://api.flutter.dev/flutter/widgets/SizedBox-class.html) definition. Supported json properties:
...
Opacity widget, here to see flutter [Opacity widget](https://api.flutter.dev/flutter/widgets/Opacity-class.html) definition. Supported json properties:
...
Wrap widget, here to see flutter [Wrap widget](https://api.flutter.dev/flutter/widgets/Wrap-class.html) definition. Supported json properties:
